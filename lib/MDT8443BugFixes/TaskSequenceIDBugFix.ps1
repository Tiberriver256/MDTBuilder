...
Rename-Item -Path "$DeploymentShare\Scripts\DeployWiz_SelectTS.vbs" -NewName "DeployWiz_SelectTS.vbs.bak"
...
End Function
"@ | Out-File "$DeploymentShare\Scripts\DeployWiz_SelectTS.vbs" -Encoding ascii
